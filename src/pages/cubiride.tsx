...
const CubiRide: React.FC<any> = () => {
  ...
  const cubiridePremiumAvatars = [
    ...
    {
      alt: "CubiBusiness",
      src: "./cubiride/icon8.svg",
      width: 175,
      height: 175,
      title: "CubiBusiness",
      descr:
        "Enjoy a spacious and comfortable ride ideal for business meetings and corporate events.",
    },
    {
      alt: "CubiPremium",
      src: "./cubiride/icon9.svg",
      width: 175,
      height: 175,
      title: "CubiPremium",
      descr:
        "Elevate your personal travel with a luxurious, private ride that offers both style and comfort.",
    },
  ];
  ...
  const cubirideSafetyPledgeAvatars = [
    {
      ...
      src: "./cubiride/icon10.svg",
      width: 175,
      height: 175,
      title: "Safety Alert Button",
      descr:
        "Quickly alert emergency contacts or authorities with just one tap during your ride.",
    },
    {
      alt: "Private Number Protection",
      src: "./cubiride/icon11.svg",
      width: 175,
      height: 175,
